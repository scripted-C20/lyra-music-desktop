...
export const mainWindowMinWidth = Math.min(...windowSizeList.map(item => item.width))
export const mainWindowMinHeight = Math.min(...windowSizeList.map(item => item.height))
