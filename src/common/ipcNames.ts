const modules = {
  ...
  winMain: {
    ...
    start_window_move: 'start_window_move',
    stop_window_move: 'stop_window_move',
    ...
    export_user_api: 'export_user_api',
    ...
    user_api_test_latency: 'user_api_test_latency',
    user_api_test_latency_cancel: 'user_api_test_latency_cancel',
  ...
  winLyric: {
    ...
    set_win_interaction_state: 'set_win_interaction_state',
    start_win_interaction: 'start_win_interaction',
    stop_win_interaction: 'stop_win_interaction',
