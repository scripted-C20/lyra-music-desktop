declare namespace LX {
  namespace DesktopLyric {
    interface Config {
      ...
      'desktopLyric.style.layout': LX.AppSetting['desktopLyric.style.layout']
      ...
      'desktopLyric.style.backgroundColor': LX.AppSetting['desktopLyric.style.backgroundColor']
    ...
    type WindowInteractionOrigin = 'move' | ResizeOrigin

    interface StartWindowInteraction {
      origin: WindowInteractionOrigin
      screenX: number
      screenY: number
    }
  }
