...
dd
  div
    .gap-top
      ...
      line-icon(class="help-icon row-help-icon" :icon="CircleHelp" :size="13" :stroke-width="2.2" :aria-label="$t('setting__other_transparent_window_tip')")
...
dd
  h3#other_resource_cache
    ...
    line-icon(class="help-icon" :icon="CircleHelp" :size="13" :stroke-width="2.2" :aria-label="$t('setting__other_resource_cache_tip')")
  div
    .p
