...
dd
  ...
  .gap-top
    ...
    line-icon(class="help-icon row-help-icon" :icon="CircleHelp" :size="13" :stroke-width="2.2" :aria-label="$t('setting__play_auto_clean_played_list_tip')")
  .gap-top
  ...
  .gap-top
    ...
    line-icon(class="help-icon row-help-icon" :icon="CircleHelp" :size="13" :stroke-width="2.2" :aria-label="$t('setting__play_lyric_lxlrc_tip')")
  .gap-top
  ...
  .gap-top(v-if="isMac")
    ...
    line-icon(class="help-icon row-help-icon" :icon="CircleHelp" :size="13" :stroke-width="2.2" :aria-label="$t('setting__play_statusbar_lyric_tip')")
  .gap-top
