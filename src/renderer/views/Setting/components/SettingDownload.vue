...
dd
  h3#download_max_num
    ...
    line-icon(class="help-icon" :icon="CircleHelp" :size="13" :stroke-width="2.2" :aria-label="$t('setting__download_max_num_tooltip')")
  div
    p
...
dd
  h3#download_use_other_source
    ...
    line-icon(class="help-icon" :icon="CircleHelp" :size="13" :stroke-width="2.2" :aria-label="$t('setting__download_use_other_source_tip')")
  div
...
dd
  h3#download_lyric_format
    ...
    line-icon(class="help-icon" :icon="CircleHelp" :size="13" :stroke-width="2.2" :aria-label="$t('setting__download_lyric_format_tip')")
  div
    base-checkbox.gap-left(
