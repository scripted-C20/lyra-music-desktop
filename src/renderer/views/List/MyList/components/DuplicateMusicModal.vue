<template>
  <material-modal
:show="visible" bg-close teleport="#view" width="60%" max-width="900px"
...
v-if="duplicateList.length" v-slot="{ item, index }" :list="duplicateList" key-name="id"
...
>
      <div :class="$style.listItem">
        ...
        <div :class="$style.textContent">
          ...
          <h3
v-if="item.musicInfo.meta.albumName" :class="[$style.text, $style.albumName]"
            :aria-label="item.musicInfo.meta.albumName"
>{{ item.musicInfo.meta.albumName }}</h3>
        </div>
