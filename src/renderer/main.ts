...
void getSetting().then(setting => {
  ...
  const lockedSetting: Partial<LX.AppSetting> = {}
  if (setting['common.controlBtnPosition'] != 'right') {
    setting['common.controlBtnPosition'] = 'right'
    lockedSetting['common.controlBtnPosition'] = 'right'
  }
  if (setting['common.playBarProgressStyle'] != 'mini') {
    setting['common.playBarProgressStyle'] = 'mini'
    lockedSetting['common.playBarProgressStyle'] = 'mini'
  }
  if (Object.keys(lockedSetting).length) void updateSetting(lockedSetting)
