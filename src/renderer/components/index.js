...
export default app => {
  requireComponent.keys().forEach(fileName => {
    ...
    // Alias common icons for backward compatibility with existing templates
    if (componentName === 'CommonLineIcon') {
      app.component('LineIcon', componentConfig.default || componentConfig)
    }
    if (componentName === 'CommonAppIcon') {
      app.component('AppIcon', componentConfig.default || componentConfig)
    }
  })
}
