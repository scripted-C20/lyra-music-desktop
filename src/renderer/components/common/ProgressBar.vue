...
.progress {
  ...
  background: linear-gradient(180deg, rgba(238, 240, 244, 0.96), rgba(230, 233, 238, 0.96));
  position: relative;
  border-radius: 999px;
...
.progressBar2 {
  ...
  box-shadow:
    ...
    0 0 10px var(--color-primary-alpha-500);
}

.progressBar3 {
  background: linear-gradient(90deg, var(--color-primary-light-100), var(--color-primary));
  box-shadow: 0 0 10px var(--color-primary-alpha-500);
  opacity: 0.82;
  border-radius: inherit;
}
