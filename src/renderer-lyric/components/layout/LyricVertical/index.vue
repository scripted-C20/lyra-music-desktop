...
.lyric {
  ...
  :global {
    ...
    .font-lrc {
      ...
      transition: color @transition-theme, opacity .26s ease;
    }
    .shadow {
      color: transparent;
      // margin-left: -0.14em;
    ...
    .line-mode .font-lrc, .extended .font-lrc {
      text-shadow:
        0 1px 0 var(--color-lyric-shadow),
        0 0 8px var(--color-lyric-shadow);
      transition: font-size @transition-slow, opacity .26s ease, text-shadow .26s ease;
    }
    .font-mode .line .shadow span {
      text-shadow:
        0 1px 0 var(--color-lyric-shadow-font-mode),
        0 0 6px var(--color-lyric-shadow-font-mode);
      // .stroke(1px, rgba(0, 0, 0, 0.07));
      transition: font-size @transition-slow, opacity .26s ease;
